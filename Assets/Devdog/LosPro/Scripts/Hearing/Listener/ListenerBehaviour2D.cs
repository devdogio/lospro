...
namespace Devdog.LosPro
{
    ...
    [AddComponentMenu(LosPro.AddComponentMenuPath + "Audio/Listener 2D")]
    public class ListenerBehaviour2D : MonoBehaviour, IListener
    {
        [SerializeField]
...
//                new RaycastAudioSourceHearableValidator(new Raycaster2D(), config)
            };
        }
