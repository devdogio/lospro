...
namespace Devdog.LosPro.Editors
{
    ...
    {
        private const string MenuItemPath = LosPro.ToolsMenuPath + "Getting started";
        private static bool _doInit = false;

        public GettingStartedEditor()
        {
            version = LosPro.Version;
            productName = LosPro.ProductName;
            documentationUrl = LosPro.ProductUrl;
            youtubeUrl = "https://www.youtube.com/playlist?list=PL_HIoK0xBTK7P_QtpeweRuhahBPGZ-q_X";
